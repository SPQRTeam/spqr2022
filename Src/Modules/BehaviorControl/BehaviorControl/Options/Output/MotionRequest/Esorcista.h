//Stop and scan. Scan and stop. // only head move
option(Esorcista, (const int) direction)  //direction: -1 for conterclockwise and 1 for clockwise
{
    initial_state(zero)
    {
        transition
