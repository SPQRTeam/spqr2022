...
//#include "Tools/SpqrTools/SPQRClassifier.h"
...
{
private:
    using SPQRBallPerceptorBase::theImage; //> prevent direct access to image
...
class SPQRBallPerceptor : public SPQRBallPerceptorScaler
{
    ...
    CascadeClassifier top_cascade;
    CascadeClassifier bottom_cascade;
